package net.mcreator.votv.block.entity;
...
public class HangInTherePosterTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public HangInTherePosterTileEntity(BlockPos pos, BlockState state) {
		super(VotvModBlockEntities.HANG_IN_THERE_POSTER.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<HangInTherePosterTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<HangInTherePosterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("hang_in_there_poster");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Hang In There Poster");
	}
